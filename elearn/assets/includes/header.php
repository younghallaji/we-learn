<?php
    ...
    if (!isset($_SESSION['id']) ) {
        ...
        $getCourse = $connect2db->prepare("SELECT * FROM course");
        $getCourse->execute();
        ...
        $getclass = $connect2db->prepare("SELECT * FROM classroom");
        $getclass->execute();
        $tcc = $getclass->rowcount();

        $getlec = $connect2db->prepare("SELECT * FROM users WHERE role = 2");
        $getlec->execute();
        $tl = $getlec->rowcount();

        $getstd = $connect2db->prepare("SELECT * FROM users WHERE role = 3");
        $getstd->execute();
        $ts = $getstd->rowcount();
    }
                ...
                <li>
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <h4 class="ml-4 mt-2">Welcome Back Administrator: <b><?php echo $name; ?></b>, Good to See You Again</h4>
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <li class="menu">
                    ...
                    <li class="menu">
                        <a href="lecturers" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                       ...
                       <!--  <ul class="collapse submenu list-unstyled" id="lecturers" data-parent="#accordionExample">
                            <li>
                                <a href="add-student"> Add Lecturer </a>
                            </li>

                            <li>
                                <a href="lecturers"> View Lecturer </a>
                            </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="course" data-parent="#accordionExample">
                            <li>
                                <a href="course-allocation"> Course Allocation </a>
                            </li>
                    ...
                    <li class="menu">
                        <a href="department" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
...
<!-- 
                    <li class="menu">
                        <a href="#classroom" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-folder"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
                                 <span> Classroom</span>
                            </div>
                        ...
                        <ul class="collapse submenu list-unstyled" id="classroom" data-parent="#accordionExample">
                            <li>
                                <a href="add-student"> Create Classroom </a>
                            </li>

                            <li>
                                <a href="students"> View Classrooms </a>
                            </li>
                    ...
                    <li class="menu">
                        <a href="classroom" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="material" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-target"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="6"></circle><circle cx="12" cy="12" r="2"></circle></svg>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="starter-kit" data-parent="#accordionExample">
                            <li>
                                <a href="exam_ques"> Exam Quesitions</a>
                            </li>
                            <li>
