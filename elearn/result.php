...
<div class="bio layout-top-spacing ">
        <div class="widget-content widget-content-area">
            ...
            <div class="bio-skill-box">
                ...
                <div class="row">
                    <?php
                        $getCourse = $connect2db->prepare("SELECT ca.course, c.title,c.code,c.dept,d.name,c.level,c.id FROM course_allocation AS ca JOIN course AS c ON ca.course = c.id JOIN department AS d ON c.dept = d.id ");
                        $getCourse->execute();
