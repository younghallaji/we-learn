<?php include 'includes/header.php';
    if (isset($_POST['upd_password'])) {
        ...
        $getpass->execute([$uid]);
        $pass = $getpass->fetch();
        $hashold = $pass->password;

        // Confirm Old Password & new password
        if (password_verify($oldpassword, $hashold) ) {
            if ($newpassword<>$confirmpassword) {
                ...
                // Update Password
                $hashnew = password_hash($newpassword, PASSWORD_BCRYPT);
                $updpassword = $connect2db->prepare("UPDATE users SET password = ? WHERE id = ?");
                if ($updpassword->execute([$hashnew,$uid])) {
                    $e = "Password Successfully Updated";
                    echo  " <script>alert('$e');</script> ";
                }
                
            }
        }else {
            $e = "Invalid Old Password";
           echo  " <script>alert('$e');</script> ";
        }
    }
?>
                ...
                <div class="row layout-spacing">
                                    ...
                                    <div class="">
                                        <ul class="contacts-block list-unstyled">
                                            <li class="contacts-block__item">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-coffee"><path d="M18 8h1a4 4 0 0 1 0 8h-1"></path><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg><?php echo $rank; ?>
                                            </li>
                                            <li class="contacts-block__item">
                                            ...
                                            <li class="contacts-block__item">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-phone"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg> <?php echo $pnum; ?>
                                            </li>
                                            <li class="contacts-block__item">
                        ...
                        <div class="education layout-spacing ">
                            <div class="widget-content widget-content-area">
                                ...
                                <form class="mt-0" method="POST">
                                            ...
                                            <button type="submit" name= "upd_password" class="btn btn-primary mt-2 mb-2 btn-block">Submit</button>
                                              </form>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                        ...
                        <div class="bio layout-spacing ">
                            <div class="widget-content widget-content-area">
                                <h3 class="">Courses Allocated</h3>
                                
                                <div class="bio-skill-box">

                                    <div class="row">
                                        <?php
                                            $getCourse = $connect2db->prepare("SELECT ca.course,c.title,c.code,c.dept,d.name,c.level FROM course_allocation AS ca JOIN course AS c on ca.course = c.id JOIN department AS d ON c.dept = d.id WHERE ca.lecturer = ? ");
                        ...
                        <div class="skills layout-spacing mt-4">
