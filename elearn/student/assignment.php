	...
	if (isset($_POST['submit'])) {
        ...
        if (in_array($fileExt, $valid_extensions)) {
        	if (move_uploaded_file($tmp_dir, $dest)) {
	                $insLink = $connect2db->prepare("INSERT INTO s_assignment (aid,sid,file,cid) VALUES (?,?,?,?)");
	                    if ($insLink->execute([$aid, $uid, $ldest, $cid])) {
            ...
            <div class="widget-content widget-content-area">
                ...
                <table class="multi-table table table-striped table-bordered table-hover non-hover" style="width:100%">
                    ...
                    <tbody>
                        <?php
                            $status = "";
                            $getStd = $connect2db->prepare("SELECT a.course,a.assign_no,a.question,a.sub_date,a.addedon,a.id, c.level, c.code FROM assignment AS a JOIN course AS c ON a.course = c.id WHERE c.level = ?");
                            $getStd->execute([$level]);
                        ...
                        <tr>
                            ...
                            <td>Assignment <?php echo $std->assign_no?></td>
                            <td><?php echo $std->code?></td>
                            <td>
                            ...
                            <td class="">
                                <div class="dropdown custom-dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                ...
                                                <a class="dropdown-item" data-target="#exampleModalCenter<?php echo $std->id?>" data-toggle="modal">Submit </a>

                                                <a class="dropdown-item" href="?code=<?php echo $std->classcode?>&delete=<?php echo $std->deleted?>&user=<?php echo $std->sid?>" onclick="return confirm('Are you Sure')">view</a>
                       ...
                       <div class="row">
	                       <form method="POST" enctype="multipart/form-data">
	                       	<div class="col-sm-12 form-group">
                                ...
                                <input type="hidden" name="cid" value="<?php echo $std->code?>">
	                       	</div>
                       </div>
                    </div>
