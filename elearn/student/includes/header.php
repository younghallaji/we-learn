<?php
    ...
    if (!isset($_SESSION['id'] )) {
        ...
        if ($getData->rowcount() > 0) {
            ...
            $deptName = $connect2db->prepare("SELECT name FROM department WHERE id = ?");
            $deptName->execute([$dept]);
            $dpn = $deptName->fetch();
            $department = $dpn->name;
                ...
                <li>
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <h4 class="ml-4 mt-2">Welcome Back Student: <b><?php echo $name; ?></b>, Good to See You Again</h4>
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <li class="menu">
                     ...
                     <li class="menu">
                        <a href="take-exam" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                                <span>Take Exam</span>
                            </div>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="course" data-parent="#accordionExample">
                            <li>
                                <a href="join-class"> Join Classroom </a>
                            </li>
                    ...
                    <li class="menu">
                        <a href="#ass" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-folder"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
                        ...
                        <ul class="collapse submenu list-unstyled" id="ass" data-parent="#accordionExample">
                            <li>
                                <a href="assignment"> View Assignment </a>
                            </li>

                            <li>
                                <a href="submitted_assignment"> Submitted Assignment </a>
                            </li>
                    ...
                    <!-- <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="starter-kit" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="starter_kit_breadcrumbs.html"> Manage Questions </a>
                            </li>
                            <li>
                                <a href="starter_kit_boxed.html"> Results </a>
                            </li>
                            <li>
