        ...
        <div class="col-xl-12 col-lg-12 col-md-12">
            ...
            <div class="chat-system">
                ...
                <div class="user-list-box">
                    ...
                    <div class="people">
                    	<?php
                        $getCourse = $connect2db->prepare("SELECT cj.classcode, cr.course, cr.instructor, u.fname, u.lname, u.id, c.title, c.code, c.dept FROM class_joined AS cj JOIN classroom AS cr ON cj.classcode = cr.class_code JOIN course AS c ON cr.course = c.id JOIN users AS u ON cr.instructor = u.id  WHERE sid = ? AND banned != ? AND suspend != ? AND deleted != ? ");
                        $getCourse->execute([$uid, 1, 1, 1]);
                        if ($getCourse->rowcount() < 1) {?>
                            <h5 class="p-3 text-danger text-center">No Active Class</h5>
                       <?php } else {
                            while ($row = $getCourse->fetch()) {?>

                        <div class="person" data-chat="<?php echo $row->classcode;?>">
                            <div class="user-info">
                                <div class="f-head">
                                ...
                                <div class="f-body">
                                    <div class="meta-info">
                                        <span class="user-name" data-name="Nia Hillyer"><?php echo $row->title;?></span>
                ...
                <div class="chat-box">
                    ...
                    <div class="chat-box-inner">
                        ...
                        <div class="chat-conversation-box" style="display:flex;flex-direction:column-reverse;">
                            <div id="chat-conversation-box-scroll" class=" p-3" >
                            	<?php
