<?php include 'includes/header.php';
    if (isset($_GET['code'])) {
        ...
        $sql = "SELECT m.title AS mtitle,m.link,m.id,m.type,c.title FROM material AS m JOIN course AS c ON m.course = c.id WHERE m.addedby = '$uid' ";
                    ...
                    <tbody>
                        ...
                        <tr class="">
                            ...
                            <td class="text-center">
                                <?php 
                                    if ($std->type==1) {?>
                                        <a href="<?php echo $std->link?>" class="text-success">
